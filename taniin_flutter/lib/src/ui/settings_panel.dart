    ...
    return ConstrainedBox(
      ...
      child: SizedBox(
        ...
        child: PixelPanel(
          ...
          child: Column(
            children: [
              _MenuHeader(title: 'MENU', icon: Icons.menu, onClose: onClose),
              Expanded(
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      width: 198,
                      child: _SettingsSidebar(farmState: farmState),
                    ),
                    Expanded(
                      child: Padding(
...
class _SettingsSidebar extends StatelessWidget {
  const _SettingsSidebar({required this.farmState});
        ...
        child: Column(
          children: [
            ...
            _SideTab(
              ...
              onTap: () {
                farmState.playClick();
                farmState.showMessage('Taniin Play to Earn mode Flutter.');
              },
            ),
          ],
        ),
  ...
  Widget build(BuildContext context) {
    return DecoratedBox(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            const Icon(Icons.volume_up, size: 48, color: Color(0xFF5BC7F3)),
